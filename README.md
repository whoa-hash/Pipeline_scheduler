This is a workthrough of using Airflow, a task scheduler. It uses Python and can be seen on the Airflow UI (usually localhost:8080 if you're running the server without setting it up differently).
